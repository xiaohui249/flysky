...
public class TarantoolQuery {
    ...
    public static void queryUser() {
        ...
        Tuple tuple = new Tuple(2).setString(0,"user-"+32,Constants.DEFAULT_ENCODE).setBoolean(1,true);
        Tuple _tuple = tc.findOne(1,1,0,tuple);

        if(_tuple != null) {
            System.out.println("userId=" + _tuple.getInt(0) + "; userName="+_tuple.getString(1, Constants.DEFAULT_ENCODE) +
