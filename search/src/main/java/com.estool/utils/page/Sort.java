 ...
 */
public class Sort implements Iterable<com.estool.utils.page.Sort.Order>, Serializable {
	...
	/**
	 * PropertyPath implements the pairing of an {@code Order} and a property.
