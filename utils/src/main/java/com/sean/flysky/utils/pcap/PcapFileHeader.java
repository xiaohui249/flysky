...
public class PcapFileHeader {
    ...
    public String toString() {
        return "PcapFileHeader [magic=" + Integer.toHexString(magic).toUpperCase()
                + ", magorVersion=" + Integer.toHexString(magorVersion).toUpperCase()
                + ", minorVersion=" + Integer.toHexString(minorVersion).toUpperCase()
                + ", timezone=" + Integer.toHexString(timezone).toUpperCase()
                + ", sigflags=" +  Integer.toHexString(sigflags).toUpperCase()
                + ", snaplen=" +  Integer.toHexString(snaplen).toUpperCase()
                + ", linktype=" +  Integer.toHexString(linktype).toUpperCase()
                + "]";
    }
}
