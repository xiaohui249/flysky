//package com.sean.flysky.utils.cache;
//
///*
...
//*/
//
//import com.sohu.smc.util.cache.CacheListener;
//import com.sohu.smc.util.cache.LruListener;
//import com.sohu.smc.util.cache.Primes;
//import com.sohu.smc.util.cache.SyncCacheListener;
//
...
//
///**
// * Fixed length com.sean.flysky.utils.cache with a LRU replacement policy.  If com.sean.flysky.utils.cache items
// * implement CacheListener, they will be informed when they're removed
// * from the com.sean.flysky.utils.cache.
// * <p/>
...
//
//    // number of items in the com.sean.flysky.utils.cache seen once
//    private int _size1;
//
...
//
//    // number of items in the com.sean.flysky.utils.cache seen more than once
//    private int _size2;
//
//    // head of the LRU list
...
//
//    /**
//     * Create the LRU com.sean.flysky.utils.cache with a specific capacity.
//     *
//     * @param initialCapacity minimum capacity of the com.sean.flysky.utils.cache
//     */
...
//
//    /**
//     * Returns the current number of entries in the com.sean.flysky.utils.cache.
//     */
//    public int size() {
...
//
//    /**
//     * Returns the LRU com.sean.flysky.utils.cache capacity
//     */
...
//
//    /**
//     * Clears the com.sean.flysky.utils.cache
//     */
//    public void clear() {
...
//
//    /**
//     * Get an item from the com.sean.flysky.utils.cache and make it most recently used.
//     *
//     * @param key key to lookup the item
//     * @return the matching object in the com.sean.flysky.utils.cache
//     */
//    public V get(K key) {
//        Object okey = key;
//        if (okey == null)
...
//
//    /**
//     * Puts a new item in the com.sean.flysky.utils.cache.  If the com.sean.flysky.utils.cache is full, remove the
//     * LRU item.
//     *
...
//
//    /**
//     * Puts a new item in the com.sean.flysky.utils.cache if the current value matches oldValue.
//     *
//     * @param key       the key
...
//     * @param key       key to store data
//     * @param value     value to be stored
//     * @param testValue tests the current value in the com.sean.flysky.utils.cache
...
//
//    /**
//     * Removes an item from the com.sean.flysky.utils.cache
//     *
...
//
//    /**
//     * Returns the keys stored in the com.sean.flysky.utils.cache
//     */
...
//
//    /**
//     * Returns keys stored in the com.sean.flysky.utils.cache using an old iterator
//     */
...
//
//    /**
//     * Returns the values in the com.sean.flysky.utils.cache
//     */
...
//
//    /**
//     * A com.sean.flysky.utils.cache item
//     */
...
//
//    /**
//     * Iterator of com.sean.flysky.utils.cache keys
//     */
//    static class KeyIterator<K, V> implements Iterator<K> {
//        private com.sean.flysky.utils.cache.LruCache<K, V> _cache;
//        private CacheItem<K, V> _item;
//        private boolean _isHead1;
//
//        KeyIterator(com.sean.flysky.utils.cache.LruCache<K, V> cache) {
//            init(cache);
//        }
//
//        void init(com.sean.flysky.utils.cache.LruCache<K, V> cache) {
//            _cache = cache;
//
//            _item = _cache._head2;
//            _isHead1 = false;
...
//
//        /**
//         * Returns the next entry in the com.sean.flysky.utils.cache.
//         */
//        @Override
...
//
//    /**
//     * Iterator of com.sean.flysky.utils.cache values
//     */
...
//        private boolean _isHead1;
//
//        ValueIterator(com.sean.flysky.utils.cache.LruCache<K, V> cache) {
//            init(cache);
//        }
//
//        void init(com.sean.flysky.utils.cache.LruCache<K, V> cache) {
...
//
//                if (entry != null)
//                    com.sean.flysky.utils.cache.LruCache.this.remove(entry._key);
//            }
//        }
//    }
//}
